...
- [~] Port encrypted secret compatibility. (Rust now performs tenant-authorized repository/instance-allowlist lookup, exact declaration completeness, byte-compatible Erlang external-term AAD and versioned AES-256-GCM decryption, zeroizing runtime values, value-free Docker arguments, job/service environment injection, and independent boundary-safe stdout/stderr redaction. Secret administration, audit/telemetry parity, and rotation remain.)
