...

{
  ...
  echo "ROBINE_BUNDLED_RUNNER_ENABLED=true"
  echo "ROBINE_LOCAL_RUNNER_ENABLED=false"
  echo "ROBINE_BUNDLED_RUNNER_BOOTSTRAP_DIRECTORY=/var/lib/robine-runner-bootstrap"
  echo "ROBINE_BUNDLED_RUNNER_NAME=robine-local"
  echo "ROBINE_RUNNER_RESOURCE_NAMESPACE=production"
  echo "ROBINE_RUNNER_CPU_MILLIS=2000"
  echo "ROBINE_RUNNER_MEMORY_BYTES=4294967296"
  echo "ROBINE_RUNNER_PIDS_LIMIT=512"
  echo "ROBINE_TRANSFER_MAX_ARCHIVE_BYTES=268435456"
