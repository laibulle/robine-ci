...
The required independent screen-reader session follows `docs/acceptance/accessibility.md`. Release evidence is schema-checked with `robine verify-acceptance`; automated checks or a fixture generated by the implementation team cannot substitute for the unfamiliar human tester.
